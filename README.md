...
[![Status](https://img.shields.io/badge/status-P4%20Planned-8B5CF6)](https://github.com/dclawstack/dclaw-policy)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/policy)

---

## Overview

DClaw Policy is an AI-native governance application. It follows the standard DClaw architecture:
...
DClaw Policy uses the **DKube Design System** with its app-specific brand color.
...
```bash
git clone https://github.com/dclawstack/dclaw-policy.git
cd dclaw-policy
```
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_policy"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-policy.git /opt/dclaw-policy
cd /opt/dclaw-policy
docker compose up -d
```

The app will be available at `https://policy.dclawstack.io`.

### Kubernetes

```bash
cd helm/dclaw-policy
helm dependency build
helm upgrade --install dclaw-policy . \
...
- [Docs](https://docs.dclawstack.io/apps/policy)
