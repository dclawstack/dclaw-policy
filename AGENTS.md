...
**DClaw Policy** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8038` (FastAPI)
- **Frontend Port:** `3038` (Next.js)
- **Database:** `dclaw_policy` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3038`
